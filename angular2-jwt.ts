...
export class AuthHttp {
  ...
  public mergeOptions(providedOpts: RequestOptionsArgs, defaultOpts?: RequestOptions) {
  ...
  public requestHelper(requestArgs: RequestOptionsArgs, additionalOptions?: RequestOptionsArgs): Observable<Response> {
